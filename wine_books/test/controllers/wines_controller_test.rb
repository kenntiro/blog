...
class WinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wine" do
    assert_difference('Wine.count') do
      post wines_url, params: { wine: { description: @wine.description, wine_name: @wine.wine_name } }
    end
  ...
  test "should update wine" do
    patch wine_url(@wine), params: { wine: { description: @wine.description, wine_name: @wine.wine_name } }
